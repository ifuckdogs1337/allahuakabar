...
# _ = input(f"How many tokens or input {Style.BRIGHT}infinite{Style.RESET_ALL} for generate and check infinite tokens : ")
count = 0
    ...
    for token in tokens:
        ...
        try:
            ...
            if r.status_code == 200:
                ...
                send(f"@everyone [{datetime.now()} | {count}] VALID: **||{token}||**")
                sleep(5)
